...
const Trail2 = () => {
  return <>
          ...
          <div className="space-y-6">
            <motion.div style={{ y: cardsParallax }} className="bg-[#005C78] p-6 rounded-lg">
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                className="bg-[#E88D67] text-white px-6 py-2 rounded-full w-full text-center"
              >
                Soon..
              </motion.button>
            </motion.div>
            ...
            <motion.div style={{ y: cardsParallax }} className="bg-[#E88D67] p-6 rounded-lg">
              ...
              <motion.button
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
                className="bg-black text-white px-6 py-2 rounded-full w-full text-center"
              >
                Soon..
              </motion.button>
            </motion.div>
      ...
      {/* page4 */}
      <div className="h-screen w-full bg-black relative hidden md:block">
      ...
      <div className="md:hidden">
        <motion.h2
          ...
          className="text-6xl font-['Quick_Peachy'] text-[#E88D67] text-center py-8 relative z-10"
        >
          REVIEWS
        </motion.h2>

        <section className="w-full bg-black relative overflow-hidden min-h-[50vh]">
          <motion.div style={{ y: reviewsParallax }} className="absolute inset-0 bg-[#E88D67] overflow-hidden">
            {/* Animated review cards */}
            {[0, 1, 2].map((row) => (
              <div key={row} className="h-1/3 w-full relative py-2">
                <div className="absolute inset-0 flex space-x-4 animate-marquee">
                  {[0, 1, 2, 3, 4].map((card) => (
                    <div key={card} className="h-5/6 w-64 flex-shrink-0 bg-[#F3F7EC] rounded-xl my-auto"></div>
                  ))}
                </div>
              </div>
            ))}
