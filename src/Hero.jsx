      ...
      <div className='h-[100vh] w-full bg-slate-400 mt-[-3vh] relative text-[#005C78] leading-[20vh] overflow-x-hidden bg-[url("./assets/images/Blue.svg")]'>
        <div className='h-screen w-full bg-[#005C78] relative text-[#005C78] leading-[20vh] overflow-x-hidden bg-[url("./assets/images/Blue.svg")]'>
          <nav className='h-[10vh] w-full bg-[#005C78] absolute top-0 bg-[url("./assets/images/Blue.svg")]'>
            <div className='mt-[7vh] h-[8vh]  relative top-0 flex'>
            ...
            className='h-[5vh] w-[15vh] text-2xl text-white absolute z-10  font-["Quick_Peachy"] ml-[58vw]  rounded-xl flex items-center justify-center cursor-pointer shadow-lg hover:bg-[#d3775b] transition duration-300'
              >
              About Me
              </button>
            ...
            className='h-[5vh] w-[13vh] text-2xl text-white absolute z-10  font-["Quick_Peachy"] ml-[68vw]  rounded-xl flex items-center justify-center cursor-pointer shadow-lg hover:bg-[#d3775b] transition duration-300'
          ...
          <button
            ...
            className='h-[5vh] w-[15vh] text-2xl text-white absolute z-10 top-[7vh] font-["Quick_Peachy"] ml-[77vw] bg-[#E88D67] rounded-xl flex items-center justify-center cursor-pointer shadow-lg hover:bg-[#d3775b] transition duration-300'
