...
const Contact = () => {
   ...
   const handleSubmit = (e) => {
    ...
    // Manually append the phone number
    ...
    // Prepare a plain object with form values (including the phone number)
    const data = {
      user_name: form.current.user_name.value,
      user_email: form.current.user_email.value,
      user_phone: PhoneNumber, // manually added phone number
      message: form.current.message.value,
    };
  
    // Send the form data to EmailJS
    emailjs
      .send('service_jmb09ry', 'template_13dwfrb', data, {
  ...
  return (
    ...
    <motion.div className='h-screen w-full absolute top-[-10vh]'>
      <motion.div className='h-[100vh] w-full bg-black relative'>
        <motion.h1 className='text-[16vh] text-black mt-[-22vh] ml-[30vw] absolute font-["Quick_Peachy"]'>
          CONTACT
        </motion.h1>
        <motion.div
          ref={form}
        ...
        >
          <h1 className='text-[10vh] text-[#E88D67] font-["Quick_Peachy"] leading-none'>
            Get in touch
          </h1>
          <h1 className='text-[10vh] text-[#F3F7EC] font-["Quick_Peachy"] leading-none'>
            with us.
          </h1>
            ...
            <label className="label flex items-center w-full h-full bg-[#F3F7EC] rounded-lg">
              <PhoneInput
                ...
                inputStyle={{
                  ...
                  width: "calc(100% - 4rem)",
                  fontSize: "35px",
                  paddingLeft: "4rem", // Space for the dial code
                  padding: "8px",
                  border: "none",
                  outline: "none",
                ...
                buttonStyle={{
                  position: "absolute",
                  left: "1rem", // Moves +91 to the left
                  zIndex: 10,
                  height: "100%",
                  display: "flex",
                  alignItems: "center",
